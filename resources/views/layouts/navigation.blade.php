                ...
                <div class="hidden sm:flex sm:items-stretch sm:m-auto">
                    <div class="flex space-x-4">
                        <a href="{{ route('dashboard') }}"
                            class="px-3 py-2 text-sm font-medium  rounded-md {{ Request::is('dashboard*') ? 'text-white bg-gray-900' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}"
                    ...
                    <div id="notification-menu"
                        ...
                        <div class="py-2 bg-white rounded-lg shadow-lg">
                            ...
                            <div class="px-4 py-2 bg-gray-100 border-t rounded-b-lg">
                                <button
                                    class="w-full px-4 py-2 text-sm text-white bg-blue-600 rounded hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
                                    Tandai Semua Dibaca
                                </button>
                            </div>
                        </div>
