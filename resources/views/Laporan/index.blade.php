                            ...
                            <tbody>
                                @foreach ($laporans as $laporan)
                                    <tr class="border-b">
                                        ...
                                        <td class="px-4 py-2">
                                            <a href="{{ route('Laporan.downloadPDF', $laporan->id) }}" class="px-2 py-1 mr-2 text-white bg-blue-500 rounded pd- hover:bg-blue-600">
                                                Unduh PDF
                                            </a>
            ...
            <section class="bg-white rounded-lg shadow-md">
                ...
                <div class="p-4">
                    <form method="POST" action="{{ route('Laporan.store') }}">
                        ...
                        <button type="submit"
                            class="px-4 py-2 text-lg text-white bg-blue-500 rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-300">
                            Submit
                        </button>
                    </form>
                </div>
